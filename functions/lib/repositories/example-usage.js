...
class ExampleUsage {
    constructor() {
        this.userRepo = new firebase_repository_1.FirebaseRepository('users');
        this.profileRepo = new firebase_repository_1.FirebaseRepository('profiles');
        this.analysisRepo = new firebase_repository_1.FirebaseRepository('analyses');
        this.postRepo = new firebase_repository_1.FirebaseRepository('posts');
    }
