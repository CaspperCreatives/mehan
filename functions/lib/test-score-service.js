...
function testScoreService() {
    ...
    try {
        ...
        console.log('Skills count:', ((_a = profile.skills) === null || _a === void 0 ? void 0 : _a.length) || 0);
        console.log('Experiences count:', ((_b = profile.positions) === null || _b === void 0 ? void 0 : _b.length) || 0);
        console.log('Education count:', ((_c = profile.educations) === null || _c === void 0 ? void 0 : _c.length) || 0);
...
// Run the test
testScoreService();
//# sourceMappingURL=test-score-service.js.map